...
def cifar10_model_fn(features, labels, mode, params, channels_first):
    ...
    attentive_resnet_model = attentive_resnet.Model(
        initial_conv_param=attentive_resnet.Model.ConvParam(
            filters=16,
            kernel_size=3,
            strides=1
        ),
        initial_pool_param=attentive_resnet.Model.PoolParam(
            pool_size=1,
            strides=1
        ),
        bottleneck=True,
        version=2,
        block_params=[
            attentive_resnet.Model.BlockParam(
                blocks=5,
                strides=1
            ),
            attentive_resnet.Model.BlockParam(
        ...
        attention_block_params=[
            attentive_resnet.Model.AttentionBlockParam(
                blocks=1
            ),
            attentive_resnet.Model.AttentionBlockParam(
                blocks=1
    ...
    logits, maps_list, masks_list = attentive_resnet_model(
        inputs=inputs,
